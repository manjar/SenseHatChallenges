...
def update_screen(mode, show_letter = False):
  if mode == "temp":
    ...
    pixels = [tempColor if i < temp_value else white for i in range(64)]
    ...
    pixels = [pressureColor if i < pressure_value else white for i in range(64)]
    ...
    pixels = [humidityColor if i < humidity_value else white for i in range(64)]
